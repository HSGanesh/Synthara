    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center', marginBottom: '40px' }}>
          ...
          <p style={{ fontSize: '13px', color: 'var(--text-muted)' }}>Synthara Developer Intelligence</p>
        </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
          ...
          {error && <p style={{ fontSize: '13px', color: '#ff5555' }}>✕ {error}</p>}
          {success && <p style={{ fontSize: '13px', color: 'var(--success)' }}>✓ {success}</p>}
